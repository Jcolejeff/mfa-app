...
import IssuesSummary from '@/components/dashboard/organization/issues-summary';
import QuickActions from '@/components/dashboard/organization/quick-actions';
import RecentIssues from '@/components/dashboard/organization/recent-issues';
